...
export const clauseChunks: ClauseChunk[] = [
  ...
  // ── DRAG-ALONG RIGHTS ───────────────────────────────────────────
  {
    ...
    marketStandard: true,
    risk: 'low',
    keywords: ['drag along', '75%', 'threshold', 'forced sale', 'M&A', 'exit', 'fully diluted'],
    negotiationTips:
